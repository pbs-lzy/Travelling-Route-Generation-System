...
function map(day,city,title,time,longitude,latitude){
	...
	var html="";
	listdiv.innerHTML="";
	html="<li><a href='javascript:void(0)' onclick='mapinfo("+longitude[0]+","+latitude[0]+")'><strong>"+(1)+"</strong>"+title[0]+"</a></li><li><a href='javascript:void(0)' onclick='mapRoute("+longitude[0]+","+latitude[0]+","+longitude[1]+","+latitude[1]+")'><strong>公共交通线路</strong></a></li>";
	for(m=1;m<title.length;m++){
		html+="<li><a href='javascript:void(0)' onclick='mapinfo("+longitude[m]+","+latitude[m]+")'><strong>"+(m+1)+"</strong>"+title[m]+"   推荐游玩时长: "+time[m]+"h</a></li><li><a href='javascript:void(0)' onclick='mapRoute("+longitude[m]+","+latitude[m]+","+longitude[m+1]+","+latitude[m+1]+")'><strong>公共交通线路</strong></a></li>";
	}
	html+="<li><a href='javascript:void(0)' onclick='mapinfo("+longitude[0]+","+latitude[0]+")'><strong>"+(title.length+1)+"</strong>"+title[0]+"</a></li>";
	
	listdiv.innerHTML="<div id='d1' class='list_home'><div class='list_title'><h3 style='color:white'>"+day+"</h3><br>"+city+"<br></div><ul>"+html+"</ul></div>";
