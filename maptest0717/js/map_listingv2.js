...
function mapRoute2(){
	...
	Location1={lat: 32.10212389126866, lng: 118.80525812089361}; 
	Location2={lat: 32.08041701905591, lng: 118.79930925614538}; 
	Location3={lat: 32.05287694557689, lng: 118.84760955880598}; 
	var currentIcon = {
        url: "img/hotel.png",
        size: new google.maps.Size(71, 71),
        origin: new google.maps.Point(0, 0),
...
//free api allows a max of 9 total stops including the start and end address
//premier allows a total of 25 stops. 
	var items = [Location1, Location2, Location3];
	var waypoints = [];
	for (var i = 0; i < items.length; i++) {
		var address = items[i];
		if (address !== "") {
...
function mapRoute3(){
	...
	currentLocation = { lat: 30.274742, lng: 120.157381 };
	Location1={lat: 30.247037091284188, lng: 120.10793370025492}; 
	Location2={lat: 30.21955677164481, lng: 120.14166764669817}; 
	Location3={lat: 30.176645379856154, lng: 120.10663333924954}; 
	var currentIcon = {
        url: "img/hotel.png",
        size: new google.maps.Size(71, 71),
        origin: new google.maps.Point(0, 0),
